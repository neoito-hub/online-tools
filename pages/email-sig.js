        ...
        <Row className="py-4">
          <Col md="6">
            <ListGroup flush>
              <ListGroupItem className="p-3">
                <Row>
                  <Col>
                    <Form onSubmit={ev => inputHandle(ev)}>
                      <Row form>
                        <Col md="6" className="form-group">
                          ...
                          <FormInput
                            ...
                            onChange={data => inputHandle(data)}
                          />
                        </Col>
                        <Col md="6">
          ...
          <Col>
            <Row className="mb-4">
              ...
              <Button style={copyButtonStyle} onClick={() => selectCopyNode("template1")} data-toggle="tooltip" data-placement="top" title="Copy!" className="copyCursor">{copy.template1}</Button>
            </Row>
            <Row className="mb-4">
              <Template2 props={formData} />
              <Button style={copyButtonStyle} onClick={() => selectCopyNode("template2")} data-toggle="tooltip" data-placement="top" title="Copy!" className="copyCursor">{copy.template2}</Button>
            </Row>
            <Row style={{ width: "100%" }}>
              <Template3 props={formData} />
              <Button style={copyButtonStyle} onClick={() => selectCopyNode("template3")} data-toggle="tooltip" data-placement="top" title="Copy!" className="copyCursor">{copy.template3}</Button>
            </Row>
          </Col>
        </Row>
      </Container>
